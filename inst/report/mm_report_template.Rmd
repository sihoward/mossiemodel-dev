...
```{r get results, eval=TRUE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r get example results, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, results=FALSE}
